...
namespace CdfApiApp.WebApi
{
	public class SwaggerConfig
	{
				...
				.EnableSwagger(c =>
					{
						...
						//
						c.SingleApiVersion("v1", "CdfApiApp.WebApi");
						...
						//
						c.DocumentFilter<BaseDocumentFilter>();
		...
		{
			return System.String.Format(@"{0}\bin\CdfApiApp.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
		}	
	}
	...
	//	public void Apply(Operation operation, SchemaRegistry schemaRegistry, System.Web.Http.Description.ApiDescription apiDescription)
	//	{
	//		if (apiDescription.HttpMethod.Method == "POST" && !apiDescription.RelativePath.Equals("User/Login"))
	//		{
	//			if (null == operation.parameters)
	//			{
	//				operation.parameters = new List<Parameter>();
	...
	//			operation.parameters.Add(new Parameter() { name = "X-MPH-AUTH", type = "string", @in = "header", description = "Identifies logged-in user.  Get this from /User/Login result Token." });
	//		}
	//	}
	//}
