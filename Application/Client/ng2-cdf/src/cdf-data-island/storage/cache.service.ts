...
import {CacheSessionStorage}            from './session-storage/cache-session-storage.service';
import {CacheLocalStorage}              from './local-storage/cache-local-storage.service';
import {CacheMemoryStorage}             from './memory/cache-memory.service';
import {StorageValueInterface}          from './storage-value.interface';

const CACHE_PREFIX = 'cdf_CacheService_';
